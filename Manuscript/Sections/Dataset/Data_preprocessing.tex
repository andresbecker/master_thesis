...
Figure \ref{fig:data_pp:outlier} shows 3 different cell nucleus sampled from the resulting \gls{tfds}. Each nucleus is in a different cell phase ($G_1$, $S$ and $G_2$ respectively), and shows a different group of 3 markers (channels).
