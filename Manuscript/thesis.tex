...
\newacronym{ns}{NS}{Nuclear Speckles}
...
\input{Sections/Introduction/Chapter_intro}
...
\input{Sections/Introduction/Thesis_Goals}
...
\chapter{The Dataset}
\label{ch:dataset}
\input{Sections/Dataset/Chapter_intro}
...
\input{Sections/Dataset/Data_Augmentation}

\section{Discussion}
\label{sec:dataset:discussion}
\input{Sections/Dataset/Discussion}
...
\input{Sections/Methodology/Chapter_intro}

\section{Dataset Setup}
\label{sec:methodology:tfds}
\input{Sections/Methodology/Dataset_Setup}

\section{Models}
\label{sec:methodology:models}
\input{Sections/Methodology/Models}

\subsection{Linear Model}
\label{sec:methodology:lm}
\input{Sections/Methodology/Linear_Model}

\newpage
\subsection{Simple CNN}
\label{sec:methodology:simple_CNN}
\input{Sections/Methodology/Simple_CNN}

\subsection{ResNet50V2}
\label{sec:methodology:RN50V2}
\input{Sections/Methodology/ResNet50V2}

\subsection{Xception}
\label{sec:methodology:XC}
\input{Sections/Methodology/Xception}

\subsection{Performance Metrics}
\label{sec:methodology:metrics}
\input{Sections/Methodology/Performance_Metrics}
...
\chapter{Results}
\label{ch:results}
\input{Sections/Results/Chapter_intro}

\section{Model Performance}
\label{sec:model_performance}
\input{Sections/Results/Model_Performance}

\subsection{Baseline values for performance metrics}
\label{sec:results:bl_values}
\input{Sections/Results/Baseline_values_for_performance_metrics}

\subsection{Model Performance Comparative}
\label{sec:results:comparative}
\input{Sections/Results/Model_Performance_Comparative}

\subsection{Linear Model}
\label{sec:results:lm}
\input{Sections/Results/Linear_Model}

\subsection{Simple CNN}
\label{sec:results:simple_cnn}
\input{Sections/Results/Simple_CNN}

\section{Model Interpretation}
\label{sec:results:model_interpretation}
\input{Sections/Results/Model_Interpretation_intro}

\subsection{Cell grouping by transcription level}
\label{sec:results:tr_cell_div}
\input{Sections/Results/Cell_grouping_by_transcription_level}

\subsection{Simple CNN model score maps}
\label{sec:results:simple_cnn_sm}
\input{Sections/Results/Simple_CNN_model_score_maps}

\subsection{Similarity between Score Maps and Cell image}
\label{sec:results:sim_sc_ci}
\input{Sections/Results/Similarity_between_Score_Maps_and_Cell_image}
...
\input{Sections/Appendix/Raw_data_processing_and_QC_Implementation_Notes}

\section{TensorFlow Dataset and image preprocessing implementation notes}
\label{sec:appendix:tfds}
\input{Sections/Appendix/TensorFlow_Dataset_and_image_preprocessing_Implementation_Notes}

\section{Model training implementation notes}
\label{sec:appendix:Model_training_IN}
\input{Sections/Appendix/Model_training_implementation_notes}
...
\input{Sections/Appendix/General_Remarks}

\section{Indirect Immunofluorescence markers description}
\label{sec:appendix:if_markers}
\input{Sections/Appendix/IF_markers_explanation}
