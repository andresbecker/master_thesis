"""MPP_DS_normal_DMSO_z_score dummy dataset."""
...
_DESCRIPTION = """
Dummy dataset containing images of Multiplexed protein maps.
...
class MPP_DS_normal_DMSO_z_score_dummy(tfds.core.GeneratorBasedBuilder):
	"""DatasetBuilder for MPP_DS_normal_DMSO_z_score_dummy dataset."""
